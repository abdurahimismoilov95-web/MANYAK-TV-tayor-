/**
 * MANYAK TV - Advanced Device Security & Strict HWID Binding System
...
export function checkAccessSecurity(
  ...
  if (isDeviceBanned) {
    return {
      ...
      banType: 'device',
      reason:
        'Ushbu qurilma (telefon/kompyuter) xavfsizlik qoidalarini buzganlik sababli MANYAK TV tizimidan butunlay bloklangan. Boshqa Telegram akkaunt ochsangiz ham ushbu qurilmadan kirish imkonsiz!',
    };
  }
