/**
 * ═══════════════════════════════════════════════════════════════════════════
 *  STORAGE SERVICE — BUTUNLAY SERVER-BASED (localStorage OLIB TASHLANDI)
 * ═══════════════════════════════════════════════════════════════════════════
 * 
 * ESKI ARXITEKTURA (❌ MUAMMO):
 * - Barcha ma'lumotlar localStorage'da saqlanardi
 * - Sahifa yangilanganda ma'lumotlar yo'qolish xavfi
 * - Server ko'chirilganda ma'lumotlar yo'qolardi
 * - Bir qurilmada qo'shilgan kontent boshqalarda ko'rinmasdi
 * - localStorage kvota muammolari (5-10MB limit)
 * 
 * YANGI ARXITEKTURA (✅ YECHIM):
 * - FAQAT JWT token localStorage'da saqlanadi
 * - Barcha ma'lumotlar server (SQLite database)'da
 * - Sahifa yangilanganda ma'lumotlar saqlanadi
 * - Server ko'chirilganda ma'lumotlar saqlanadi
 * - Bir qurilmada o'zgartirish - hamma joyda ko'rinadi
...
// ═══════════════════════════════════════════════════════════════════════════
//  localStorage'DA FAQAT JWT TOKEN SAQLANADI
// ═══════════════════════════════════════════════════════════════════════════
// Barcha boshqa ma'lumotlar server API orqali olinadi va saqlanadi.
