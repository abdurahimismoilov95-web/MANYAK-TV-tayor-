...
export interface Comment {
  ...
  episodeId?: string; // Episode ID (agar serial/drama bo'lsa)
  userId: string; // Foydalanuvchi Telegram ID
  username: string; // Foydalanuvchi ismi
  text: string; // Komment matni
...
export interface UserProfile {
  ...
  accessTokens?: number; // Bonus tokens - seriallarda har 10 qismga 1 ta qism ochish imkoniyati
